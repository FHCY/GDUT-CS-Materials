...
quietly set PROJECT_DIR "C:/Users/FHCY/Desktop/J3224008944_SLC"
...
vlog -vlog01compat -work postlayout "${PROJECT_DIR}/designer/impl1/lly_VM_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -vlog01compat -work postlayout "${PROJECT_DIR}/stimulus/test_FSM.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /u0=${PROJECT_DIR}/designer/impl1/lly_VM_ba.sdf postlayout.test_lly_VM
add wave /test_lly_VM/*
run 1000ns
