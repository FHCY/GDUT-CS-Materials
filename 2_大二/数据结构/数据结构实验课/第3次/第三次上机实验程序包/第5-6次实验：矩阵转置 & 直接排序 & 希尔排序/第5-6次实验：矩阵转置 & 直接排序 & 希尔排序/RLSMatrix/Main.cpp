...
int main() {     
    ...
    MultSMatrix(M1, N1, Q1);
    printf("Q1\n row=%d, column=%d, unit=%d\n", Q1.mu, Q1.nu, Q1.tu);
    for (int i = 1; i <= Q1.mu; i++)
        printf(" rpos[%d]=%d ", i, Q1.rpos[i]);
    printf("\n");
    for (int i = 1; i <= Q1.tu; i++)
        printf(" (%d,%d,%d) ", Q1.data[i].i, Q1.data[i].j, Q1.data[i].e);
    printf("\n\n");
    ...
    printf("Q2\n row=%d, column=%d, unit=%d\n", Q2.mu, Q2.nu, Q2.tu);
    for (int i = 1; i <= Q2.mu; i++)
        printf(" rpos[%d]=%d ", i, Q2.rpos[i]);
    printf("\n");
    for (int i = 1; i <= Q2.tu; i++)
        printf(" (%d,%d,%d) ", Q2.data[i].i, Q2.data[i].j, Q2.data[i].e);
    return 0;
}
